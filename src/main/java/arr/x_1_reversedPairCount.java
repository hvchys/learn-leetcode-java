...
public class x_1_reversedPairCount {
    ...
    public static int getReversedPairNum(int[] arr, int idxStart, int idxEnd){
        // 返回 arr[idxStart] ~ arr[idxEnd] 里面的逆序数量
        if(idxStart >= idxEnd)
            return 0;
...
//
//        int part1 = getReversedPairNum(arr, idxStart, mid);
//        int part2 = getReversedPairNum(arr, mid + 1, idxEnd);
//        int midAns = getPairBetweenToArrs(arr, idxStart, mid, idxEnd);
